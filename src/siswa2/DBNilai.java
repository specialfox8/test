...
public class DBNilai {
    ...
    public void setNilaiModel(NilaiModel s) {
        ...
        try {
            ...
            Koneksi con = new Koneksi();            con.bukaKoneksi();
        ...
        int val = 0;
        try {         Koneksi con = new Koneksi();            con.bukaKoneksi();
            con.statement = con.dbKoneksi.createStatement();
            ResultSet rs = con.statement.executeQuery(          "select count(*) as jml from nilai where NPM = '" + nomor + 
                            "' and kodemk='"+kode+"'");
            while (rs.next()) {                val = rs.getInt("jml");            }            con.tutupKoneksi();
...
"insert into nilai (NPM,kodemk,tanggal, nilai,hadir) values (?,?,?,?,?)");
 ...
 public boolean delete(String nomor,String kode) {
        ...
        try {            con.bukaKoneksi();;
            ...
            con.preparedStatement.executeUpdate();            berhasil = true;
